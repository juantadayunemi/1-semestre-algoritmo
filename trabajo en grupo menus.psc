...
//1) Determinar cuánto se debe pagar por cierta cantidad de colas, considerando que si son más de 23 colas, 
//el costo por unidad es de $0,50 caso contrario el precio será 20% mas.
...
Funcion ganancia = calcularGananciaUva(tipo, tamaño, precioInicial)
    ...
    Si tipo = "a" Entonces
        Si tamaño = 1 Entonces
            precioInicial =  precioInicial + 20  // Precio inicial para tipo A, tamaño 1
		SiNo
            precioInicial = precioInicial + 30  // Precio inicial para tipo A, tamaño 2
        FinSi
	SiNo
        Si tamaño = 1 Entonces
            precioInicial = precioInicial - 30  // Precio inicial para tipo B, tamaño 1
		SiNo
            precioInicial =precioInicial - 50  // Precio inicial para tipo B, tamaño 2
        FinSi
    FinSi
	...
	Repetir
		...
		Segun opcionSeleccionada Hacer
			...
			Caso 2:
				...
				ganancia = calcularGananciaUva(tipo, tamaño, precioInicial)
